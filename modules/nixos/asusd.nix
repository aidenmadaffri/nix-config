...
in
{
  ...
  config = lib.mkIf cfg.enable {
    environment.systemPackages = [ pkgs.unstable.asusctl ];
    ...
    systemd.packages = [ pkgs.unstable.asusctl ];
    services.dbus.packages = [ pkgs.unstable.asusctl ];
    services.udev.packages = [ pkgs.unstable.asusctl ];
